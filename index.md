...
As a Customer Operations Specialist in the Falcon Complete team I was the first point of contact for new Falcon Complete customers. Working closely with them during their onboarding of Falcon Complete managed Endpoint Protection, Identity and Next-Gen SIEM. 

I worked in collaboration with other teams within Falcon Complete and the wider CrowdStrike team including Sales, Security Advisors and Security Analysts, always with a focus on providing an amazing customer onboarding experience while demonstrating immediate time to value for customers. I assisted customers to ensure their implementation of CrowdStrike Falcon was successful and straightforward, considering their business and cybersecurity needs throughout the journey. 
...
* Writing documentation, guides, and standard operating procedures for our managed services offerings.
* Onboarding management for major client, including Exchange Hybrid migration and implementation of new security tools across 4 offices and 150 staff.
...
Leading a small team in the scoping, design and delivery of client projects. Included workstation and server/infrastructure deployments and refreshes, onboarding of new Ever Nimble clients, office infrastructure fit outs and moves. Implementation of Ever Nimble's managed services offerings.
